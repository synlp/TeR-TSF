...
parser.add_argument("--config", type=str, default="agriculture_36_18.yaml")
...
parser.add_argument("--data", type=str, default="pretrain_timemmd")
parser.add_argument("--data_name", type=str, default="Agriculture")
parser.add_argument("--embed", type=str, default="timeF")
parser.add_argument('--root_path', type=str, default='/media/ubuntu/data/collaborations/tsf/TeR-TSF/my_datasets/Time-MMD', help='')
